...
export function Signup() {
    return (
        <div className="w-screen h-screen bg-gray-900 flex items-center flex-col justify-center text-gray-100">
            ...
            <Heading size="lg" className='flex items-center gap-3'>NG Cash <span className='h-1 rounded-full border-l-4 border-gray-100'></span> Cadatro</Heading>
                <Text size="lg" className="text-gray-400 mt-1">Faça seu cadastro e comece a usar</Text>
            </header>
            ...
            <form className="flex flex-col gap-4 mt-10 w-full max-w-sm items-stretch">
                <label className="flex flex-col gap-3" htmlFor="username">
                    <Text className="font-semibold">Informe seu nome de usuário</Text>
                    <TextInput.Root>
                        <TextInput.Icon>
                            <User />
                        </TextInput.Icon>
            ...
            <footer className='flex flex-col items-center mt-8'>
                ...
                <Link to="/" className="text-gray-400 underline hover:text-gray-200">Possui uma conta? Faça login agora!</Link>
                </Text>
            </footer>
        </div>
    )
